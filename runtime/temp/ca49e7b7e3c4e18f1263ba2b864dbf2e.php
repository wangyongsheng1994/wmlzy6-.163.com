<?php /*a:3:{s:70:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\email\index.html";i:1524816704;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\header.html";i:1524816903;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\footer.html";i:1524816895;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<a href="javascript:;" onclick=member_add('发送邮件','<?php echo url('add'); ?>','1100','800') class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 发送邮件</a>
			<a href="javascript:;" onclick=member_send('已删除','<?php echo url('lastdelete'); ?>') class="btn btn-primary radius"><i class="Hui-iconfont">&#xe62b;</i>已删除</a>
		</span>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td><?php echo htmlentities($arr[$vo['status']]); ?></td>
				<td><?php echo htmlentities($vo['title']); ?></td>
				<td><?php echo htmlentities(mb_substr($vo['content'],0,22)); ?>... ...<u style="cursor:pointer" class="text-primary" onclick=member_show('邮件-查看','<?php echo url('detail',array('id'=>$vo['id'])); ?>','<?php echo htmlentities($vo['id']); ?>','800','600')>点我查看</u></td>

				<td><?php echo htmlentities(date("Y-m-d H:i:s",!is_numeric($vo['time'])? strtotime($vo['time']) : $vo['time'])); ?></td>
				<td class="td-status">
					<?php if($vo['state'] == 1): ?>
					<span class="label label-default radius">已读</span>
					<?php else: ?>
				...
				<td class="td-manage">
					<?php if($vo['state'] == 1): ?>
					<a onClick="admin_start(this,<?php echo htmlentities($vo['id']); ?>)" href="javascript:;" title="标为未读" style="text-decoration:none"><i class="Hui-iconfont">&#xe615;</i></a>
					<?php else: ?>
					<a onClick="admin_stop(this,<?php echo htmlentities($vo['id']); ?>)" href="javascript:;" title="标为已读" style="text-decoration:none"><i class="Hui-iconfont">&#xe631;</i></a>
					<?php endif; ?>

				<a title="编辑" href="javascript:;" onclick="member_edit('查看详情','member-add.html','4','','510')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
...
function member_del(obj,id){
	layer.confirm('确认要删除吗？',function(index){
		var url = "<?php echo url('receivedel'); ?>";
