<?php /*a:3:{s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\article\index.html";i:1524904257;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\header.html";i:1524816903;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\footer.html";i:1524816895;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<a href="javascript:;" onclick=member_add('添加文章','<?php echo url('add'); ?>','1100','800') class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加文章</a>
		</span>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td><?php echo htmlentities($vo['webcate']['industry']); ?></td>
				<td><?php echo htmlentities($vo['title']); ?></td>
				<td><?php echo htmlentities($vo['autor']); ?></td>
				<td><?php echo htmlentities($vo['descr']); ?></td>
				<td>
					<a href="<?php echo htmlentities($vo['image']); ?>" data-lightbox="gallery" data-title="<?php echo htmlentities($vo['title']); ?>">
						<img src="<?php echo htmlentities($vo['image']); ?>" height="50px">
					</a>
				</td>
