<?php /*a:3:{s:73:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\customer\index.html";i:1525341083;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\header.html";i:1524816903;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\footer.html";i:1524816895;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$row): if(is_array($row['customer']) || $row['customer'] instanceof \think\Collection || $row['customer'] instanceof \think\Paginator): if( count($row['customer'])==0 ) : echo "" ;else: foreach($row['customer'] as $key=>$voo): ?>
			<tr class="text-c">
				...
				<td><?php echo mb_substr($voo['descr'],0,20); ?>... ...<u style="cursor:pointer" class="text-primary" onclick=member_show('客户-内容详情','<?php echo url('detail',array('id'=>$voo['id'])); ?>','<?php echo htmlentities($voo['id']); ?>','800','800')>点我查看</u></td>
				...
				<td class="td-manage">
					...
					<a title="编辑" href="javascript:;" onclick=member_edit('编辑','<?php echo url("edit",["id"=>$voo['id']]); ?>','4','1100','800') class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
