<?php /*a:3:{s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\webcate\index.html";i:1524817037;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\header.html";i:1524816903;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\footer.html";i:1524816895;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<body>
<nav class="breadcrumb"><i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 网站类别中心 <span class="c-gray en">&gt;</span> 网站类别管理 <a class="btn btn-success radius r" style="line-height:1.6em;margin-top:3px" href="javascript:location.replace(location.href);" title="刷新" ><i class="Hui-iconfont">&#xe68f;</i></a></nav>
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			<a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a>
			<a href="javascript:;" onclick=member_add('添加类别','<?php echo url('add'); ?>','1100','800') class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加类别</a>
		</span>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td><?php echo str_repeat('|——',$vo['level']); ?><?php echo htmlentities($vo['industry']); ?></td>
				<td class="td-manage">
				
				<a title="编辑" href="javascript:;" onclick=member_edit('查看详情','<?php echo url('edit',['id'=>$vo['id']]); ?>','800','900') class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
