<?php /*a:3:{s:67:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\role\add.html";i:1524816925;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\header.html";i:1524816903;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\footer.html";i:1524816895;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<article class="page-container">
	<form class="form form-horizontal" id="form-admin-add">
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-2"><span class="c-red">*</span>角色选择：</label>
			<div class="formControls col-xs-8 col-sm-9">
				...
				<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): if( count($data)==0 ) : echo "" ;else: foreach($data as $key=>$row): ?>
					<option value="<?php echo htmlentities($row['id']); ?>"><?php echo str_repeat('|——',$row['level']); ?><?php echo htmlentities($row['name']); ?></option>
