<?php /*a:3:{s:69:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\role\index.html";i:1524816935;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\header.html";i:1524816903;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\footer.html";i:1524816895;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
  ...
  <table class="table table-border table-bordered table-bg">
    ...
    <tbody>
      ...
      <tr class="text-c">
        ...
        <td><?php echo str_repeat('--|',$row['level']); ?><?php echo htmlentities($row['name']); ?></td>
        ...
        <td class="td-manage">
          ...
          <a title="权限分配" href="javascript:;" onclick=admin_edit('权限分配',"<?php echo url('role',array('id'=>$row['id'])); ?>",'<?php echo htmlentities($row['id']); ?>','900','800') class="ml-5" style="text-decoration:none"><i class="iconfont">&#xe61f;</i></a>
        </td>
      </tr>
