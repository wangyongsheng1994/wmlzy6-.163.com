<?php /*a:3:{s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\project\index.html";i:1525316236;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\header.html";i:1524816903;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\footer.html";i:1524816895;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
    ...
    <tbody>
      ...
      <tr class="text-c">
        ...
        <td><?php echo mb_substr($vo['content'],0,16); ?>... ...<u style="cursor:pointer" class="text-primary" onclick=member_show('内容查看','<?php echo url('detail',array('id'=>$vo['id'])); ?>','<?php echo htmlentities($vo['id']); ?>','800','600')>点我查看</u></td>
        ...
        <a title="编辑" href="javascript:;" onclick=member_edit('项目修改','<?php echo url('edit',['id'=>$vo['id']]); ?>','800','900') class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>
