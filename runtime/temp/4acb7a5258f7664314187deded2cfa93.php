<?php /*a:1:{s:70:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\index\index.html";i:1524913849;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<header class="navbar-wrapper">
	<div class="navbar navbar-fixed-top">
		<div class="container-fluid cl"> <a class="logo navbar-logo f-l mr-10 hidden-xs" href="<?php echo url('/admin/index/index'); ?>">OA办公系统</a> <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/aboutHui.shtml"></a> 
			<span class="logo navbar-slogan f-l mr-10 hidden-xs"></span> 
			<a aria-hidden="false" class="nav-toggle Hui-iconfont visible-xs" href="javascript:;">&#xe667;</a>
			
		<nav id="Hui-userbar" class="nav navbar-nav navbar-userbar hidden-xs">
			<ul class="cl">
				<li><?php echo htmlentities(app('session')->get('rolename')); ?></li>
				<li class="dropDown dropDown_hover">
					<a href="#" class="dropDown_A"><?php echo htmlentities(app('session')->get('username')); ?><i class="Hui-iconfont">&#xe6d5;</i></a>
					<ul class="dropDown-menu menu radius box-shadow">
						<li><a href="javascript:;" onclick="admin_add('个人信息','<?php echo url('info'); ?>','900','600')">个人信息</a></li>
		...
		<dl id="menu-article">
			...
			<dd>
				<ul>
					...
					<li><a data-href="/admin/<?php echo htmlentities($voo['mname']); ?>/<?php echo htmlentities($voo['aname']); ?>" data-title="<?php echo htmlentities($voo['name']); ?>" href="javascript:void(0)"><?php echo htmlentities($voo['name']); ?></a></li>
