<?php /*a:3:{s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\message\index.html";i:1524816857;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\header.html";i:1524816903;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\footer.html";i:1524816895;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<a href="javascript:;" onclick=member_add('添加信息','<?php echo url('add'); ?>','1100','800') class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加信息</a>
		</span>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			<?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;if(is_array($vo['message']) || $vo['message'] instanceof \think\Collection || $vo['message'] instanceof \think\Paginator): $i = 0; $__LIST__ = $vo['message'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($i % 2 );++$i;?>
			<tr class="text-c">
				<td><input type="checkbox" value="<?php echo htmlentities($vo['id']); ?>" name=""></td>
				<td><?php echo htmlentities($voo['id']); ?></td>
				<td><?php echo htmlentities($vo['industry']); ?></td>
				<td><?php echo htmlentities($voo['name']); ?></td>
				<td><?php echo htmlentities($voo['url']); ?></td>
				<td><?php echo htmlentities($voo['username']); ?></td>
				<td class="td-manage">
				
				<a title="编辑" href="javascript:;" onclick=member_edit('查看详情','<?php echo url('edit',['id'=>$voo['id']]); ?>','800','900') class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6df;</i></a>

				<a title="删除" href="javascript:;" onclick="member_del(this,'<?php echo htmlentities($voo['id']); ?>')" class="ml-5" style="text-decoration:none"><i class="Hui-iconfont">&#xe6e2;</i></a>
