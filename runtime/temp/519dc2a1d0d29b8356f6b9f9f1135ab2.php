<?php /*a:3:{s:69:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\seal\index.html";i:1524884895;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\header.html";i:1524816903;s:72:"D:\phpstudy\PHPTutorial\WWW\oa\application\admin\view\public\footer.html";i:1524816895;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
<meta charset="utf-8">
...
<div class="page-container">
	<div class="cl pd-5 bg-1 bk-gray mt-20">
		<span class="l">
			...
			<a href="javascript:;" onclick=member_add('添加记录','<?php echo url('add'); ?>','1100','800') class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加记录</a>
		</span>
	...
	<table class="table table-border table-bordered table-hover table-bg table-sort">
		...
		<tbody>
			...
			<tr class="text-c">
				...
				<td><?php echo htmlentities($vo['seal_descr']); ?></td>
				<td><?php echo htmlentities($vo['seal_type']); ?></td>
				<td><u style="cursor:pointer" class="text-primary" onclick=member_show('查看详情','<?php echo url('detail',array('id'=>$vo['id'])); ?>','<?php echo htmlentities($vo['id']); ?>','800','800')>查看详情</u></td>
				<td class="td-manage">
